...
abstract class ThinkOauth
{
    ...
    public function __construct($token = null)
    {
		...
		switch($this->Type){
			case 'QQ':
				$config['app_key'] = C("QQ_APPID");
				$config['app_secret'] = C("QQ_APPKEY");
				//$config['callback'] = C("CFG_WEBURL").U('Oauth/login?type=qq');
				$config['callback'] = C("QQ_CALLBACK");
			break;
			case 'SINA':
				$config['app_key'] = C("SINA_APPID");
				$config['app_secret'] = C("SINA_APPKEY");
				$config['callback'] = C("SINA_CALLBACK");
			break;
			default:
				$config['app_key'] = '';
				$config['app_secret'] = '';
