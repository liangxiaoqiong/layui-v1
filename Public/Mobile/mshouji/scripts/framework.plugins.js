        ...
        var r = {
            ...
            o = {
                ...
                klass: {
                    ...
                    remove: function(e, t ,IsQuery) {
                        if (r.addBodyClasses) {
                            
                            if(IsQuery){
                              e.attr('class',e.attr('class').replace(t, "").replace(/^\s+|\s+$/g, ""));//anair_update
                            }else{
                    ...
                    easeCallback: function() {
                        ...
                        if (i.easingTo === 0) {
                        	$(function (){
							     ...
							     o.klass.remove($('.header'),"hide-header-left",true);//anair_add
							     o.klass.remove($('.footer-ball'),"hide-header-left",true);//anair_add
                        	})
                        }
