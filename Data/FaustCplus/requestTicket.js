...
function(g) {
    ...
    return function(j) {
        ...
        k.okLabel(j.okLabel || "ȷ��");
        k.cancelLabel(j.cancelLabel || "ȡ��");
        if (j.OK) {
        ...
        k.setMiddle().open(j.from || null).setTitle(j.title || "��ʾ")
    }
});
...
function(a) {
    var b = {
        A00001: "�ܱ�Ǹ��������ط�������ߣ��˹�������ά���У��ᾡ��ָ��������������ϵ@΢��С���� �����µ�ͷ��绰400 690 0000��",
        A00003: "��Ȩ�޲�����",
        A00006: "����ɹ�",
        E00001: "ϵͳ��æ",
        E00002: "��������",
...
function(f) {
    ...
    j = f.common.bubble();
    var b = {
        M01106: e("#L{�ܱ�Ǹ���˹�������ά���У���ʱ�޷��ṩ��}"),
        M01107: e("#L{���ϴ�jpg��gif��ʽ��ͼƬ��}"),
        M07006: e("#L{�ϴ�ʧ�ܣ��������ϴ���}"),
        M01152: e("#L{��ѡ�񲻳���2M��ͼƬ}"),
        M01109: e("#L{����ʧ�ܣ������ԡ�}"),
        M01108: e("#L{���ϴ��ļ���С������5M��ͼƬ��}"),
        CX0182: e("#L{ѡ����Ƭ}"),
        CX0183: e("#L{���ڼ������е�ͷ��...}"),
        CX0184: e("#L{���ڶ�ȡ�У����Ժ�...}"),
        CX0185: e("#L{���ͼƬ�ļ�����5M���߳���2880���أ���ѡ���ļ��ͳߴ��С��ͼƬ}"),
        CX0186: e("#L{ȡ��}"),
        CX0187: e("#L{���...}"),
        CX0188: e("#L{����}"),
        CX0189: [e("#L{���ϴ���ͷ����Զ��������ֳߴ磬}"), "\n", e("#L{��ע����С�ߴ��ͷ���Ƿ�����}")].join(""),
        CX0190: e("#L{��ߴ�ͷ��180��180����}"),
        CX0191: [e("#L{�гߴ�ͷ��}"), "\n", e("#L{50��50����}"), "\n", e("#L{(�Զ�����)}")].join(""),
        CX0192: [e("#L{С�ߴ�ͷ��}"), "\n", e("#L{30��30����}"), "\n", e("#L{(�Զ�����)}")].join(""),
        CX0193: e("#L{��֧��JPG��GIF��PNGͼƬ�ļ������ļ�С��5M}"),
        CX0194: e("#L{������ת}"),
        CX0195: e("#L{������ת}"),
        CC1503: e("#L{��ȴ�ͼƬ�ϴ�}"),
        CC1501: e("#L{��ѡ��ͼƬ}"),
        CC1502: e("#L{�ļ���ʽ����ȷ����ѡ��JPG��GIFͼƬ��ʽ}"),
        CC1503: e("#L{��ȴ�ͼƬ�ϴ� }")
    };
    var g = function(l) {
